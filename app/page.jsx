    ...
    <section className='w-screen h-screen bg-background md:flex md:justify-center md:items-center lg:flex lg:justify-center lg:items-center'>
      ...
      <div className='flex flex-col justify-center items-center space-y-10 mt-16 p-5 md:mt-0 md:p-0 lg:mt-0 lg:p-0'>
        ...
        <div className='space-y-5 relative flex flex-col items-center'>
          ...
          <motion.h2
            className='absolute rotate-12 text-transparent text-6xl font-extrabold -top-[20%] -left-[20%] transform -translate-x-1/2 -translate-y-1/2 bg-clip-text bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 hover:animate-pulse z-0'
        ...
        <div className='flex flex-col overflow'>
          ...
          /> */}
          <motion.h2
            className='absolute rotate-12 text-transparent text-6xl font-extrabold top-2/3 left-24 bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 '
          ...
          <motion.h2
            className='absolute rotate-12 text-transparent text-6xl font-extrabold top-1/3 right-24 bg-clip-text bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500'
            initial={{ opacity: 0, x: -100 }} // Начальное состояние (невидимое и сдвинутое)
          ...
          <motion.h2
            className='absolute h-16 rotate-12 text-transparent text-6xl font-bold top-[77%] left-[62%] text-center bg-clip-text bg-gradient-to-r from-fuchsia-600 to-pink-600 '
